              ...
              <React.Fragment key={i.num}>
                <div className="flex items-center shrink-0">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${
                    step >= i.num ? 'bg-accent text-white' : 'bg-gray-100 text-gray-400'
                  }`}>
            ...
            {step === 1 && (
              ...
              >
                ...
                <div className="flex justify-end mt-8">
                  <Button
                    onClick={() => setStep(2)}
                    disabled={!form.categoria || especialidadesSelecionadas.length === 0}
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      { valor: 'pequeno', label: 'Pequeno', desc: '1-6 horas', cor: 'green' },
                      { valor: 'medio', label: 'Médio', desc: '24-48 horas', cor: 'yellow' },
                      { valor: 'grande', label: 'Grande', desc: '+48 horas', cor: 'red' }
                    ].map((opcao) => (
                      <button
                        key={opcao.valor}
                        onClick={() => {
                          setTamanhoSelecionado(opcao.valor as any);
                          setForm(prev => ({ ...prev, tamanho: opcao.valor as any }));
                        }}
                        className={`p-4 border-2 rounded-xl text-center transition-all ${
                          form.tamanho === opcao.valor
                            ? `border-${opcao.cor}-500 bg-${opcao.cor}-50`
                            : 'border-gray-200 hover:border-gray-300'
                        }`}
                      >
                        <p className={`font-bold ${
                          form.tamanho === opcao.valor ? `text-${opcao.cor}-700` : 'text-primary'
                        }`}>
                          {opcao.label}
                        </p>
                        <p className={`text-xs ${
                          form.tamanho === opcao.valor ? `text-${opcao.cor}-600` : 'text-gray-400'
                        }`}>
                          {opcao.desc}
                        </p>
                      </button>
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <Button
                    onClick={() => setStep(3)}
                    disabled={!form.descricao || form.descricao.length < 10 || !form.dataAgendada || !form.horaAgendada || !form.endereco.bairro || !form.endereco.referencia}
                    className="bg-accent hover:bg-accent/90 text-white"
                  >
                    Continuar
                  </Button>
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <Button
                    onClick={() => setStep(4)}
                    disabled={form.tamanho !== 'grande' && !form.prestadorId && prestadoresDisponiveis.length > 0}
                    className="bg-accent hover:bg-accent/90 text-white"
                  >
