                ...
                <div key={feature.id} className="relative">
                  <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 h-full">
                    <div className="relative h-48 mb-6 rounded-2xl overflow-hidden bg-gradient-to-br from-accent/10 to-accent/5">
                      {images[field] ? (
                        <img src={images[field] as string} alt={feature.title} className="w-full h-full object-cover" />
                      ) : (
                  ...
                  <div key={cat.id} className="group">
                    <Link to={`/servicos?cat=${cat.id}`}>
                      <div className="bg-white p-8 rounded-3xl shadow-md border border-gray-100 h-full hover:shadow-2xl transition-all">
                        ...
                        <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${cat.color} flex items-center justify-center text-white mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-transform`}>
                          <cat.icon size={32} />
                        </div>
                ...
                <div key={num} className="relative group">
                  <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all">
                    <div className="relative h-24 w-full rounded-lg overflow-hidden bg-gray-50">
                      {images[field] ? (
                        <img src={images[field] as string} alt={`Partner ${num}`} className="w-full h-full object-contain p-4 group-hover:scale-110 transition-transform" />
                      ) : (
                        <div className="w-full h-full flex items-center justify-center">
